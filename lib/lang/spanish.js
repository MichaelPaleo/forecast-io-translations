...
function strip_prefix(period) {
  return period.slice(0, 9) === "durante la noche" ? period.slice(4) :
         period.slice(0, 7) ===   "en el " ? period.slice(7) :
                                              period;
}
...
module.exports = require("../template")({
  ...
  "temperatures-falling": "temperaturas caen a $1 $2",
   /* In spanish "and" = "y", i dont know regexp but i try some and get this exp
	* This expression does not contemplate words that start with "y" and end with "y".
	* In Spanish i think there are only 3 words that begin and end with "y" and are not related to weather. but maybe you could help with the correct expression
    */
  "title": function(str) {
    return str.replace(
      /\b[^\Wy]/g,
